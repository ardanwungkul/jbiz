...
<div class="container-fluid grid-cols-5 grid p-10 bg-gray-900">
    <div class="col-span-2 text-white ml-5 ">
        <h5 class="text-3xl font-extrabold mb-5">Contact Us</h5>
        <div class="flex gap-2 my-3">
            <i class="fa-solid fa-location-dot mt-1" style="color: #ffffff;"> </i>
            <p class="text-sm">Komplek PU Blok B1 No.10, Buah Batu (Cipagalo Cipagalo Bojongsoang, Kujangsari, Kec. Bandung Kidul, Kota Bandung, Jawa Barat 40287</p>
        </div>
        <div class="flex gap-2 my-3">
    ...
    <div class=" col-span-3 bg-gradient-to-b from-gray-800 rounded-lg mx-32 ">
        <div class="w-full px-8 py-5 ">
            ...
            @endif
                <form method="POST" >
                    ...
                    <button type="submit" class="text-black tracking-wider bg-gray-200 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm w-full sm:w-auto px-5 py-2.5 text-center">Submit</button>
                </form>
            </div>
        </div>

<nav x-data="{ open: false }" class="z-10">
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex justify-between h-16">
            <div class="flex">
                <!-- Logo -->
                <div class="items-center w-32 mx-auto flex">
    ...
    <div :class="{ 'block': open, 'hidden': !open }" class="hidden sm:hidden">
        <div class="pt-2 pb-3 space-y-1">
            ...
            <x-responsive-nav-link :href="route('domain.index')" :active="request()->routeIs('domain.index')">
                {{ __('Domain') }}
            </x-responsive-nav-link>
            <x-responsive-nav-link :href="route('pelanggan.index')" :active="request()->routeIs('pelanggan.index')">
                {{ __('Pelanggan') }}
            </x-responsive-nav-link>
            <x-responsive-nav-link :href="route('nameserver.index')" :active="request()->routeIs('nameserver.index')">
                {{ __('Nameserver') }}
            </x-responsive-nav-link>

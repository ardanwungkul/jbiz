<x-app-layout>
    ...
    <section class="bg-white dark:bg-gray-900 pt-3 ">
        <div class="pb-3 pt-2 px-4 mx-auto mt-5 rounded-xl max-w-2xl lg:pb-6 lg:pt-2 bg-gray-600">
                ...
                <div class="grid gap-4 sm:grid-cols-2 sm:gap-6">
                        ...
                        <div class="w-full">
                            ...
                            <div class="w-full text-white text-sm">
                                {{  date('j \\ F Y', strtotime($domain->tanggal_mulai )) }} - {{  date('j \\ F Y', strtotime($domain->tanggal_expired)) }}
                            </div>
                        </div>
                ...
                @endif
                        ...
                        <div class="grid grid-cols-4 col-span-2 mt-4">
                            <label for="jumlah_email" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Nama Domain</label>
                            <input disabled type="text" value="{{$domain->nama_domain}}" name="jumlah_email" id="jumlah_email" class="col-span-3 bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500"  required="">
                        </div>
                    <div class="grid grid-cols-4 col-span-2 ">
                        <label for="epp_code" class="col-span-1 block mb-2 text-sm font-medium text-gray-900 dark:text-white">EPP Code</label>

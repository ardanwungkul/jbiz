    ...
    <section class="bg-white dark:bg-gray-900">
        <div class="py-8 px-4 mx-auto max-w-2xl lg:py-16">
            ...
            <form action="{{ route('nameserver.store') }}" method="post">
                ...
                <button type="submit"
                    class=" bg-gray-600 text-white p-3 rounded shadow-sm focus:outline-none hover:bg-gray-500 items-center px-5 py-2.5 mt-4 sm:mt-6 text-sm font-medium text-center bg-primary-700 focus:ring-4 focus:ring-primary-200 dark:focus:ring-primary-900 hover:bg-primary-800">
                    Simpan
                </button>
            </form>
        </div>

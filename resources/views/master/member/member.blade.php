<x-app-layout>
    ...
    <div class="mt-10 mb-4 border-b border-gray-200 dark:border-gray-700">
    ...
    <div id="myTabContent" class="px-10">
        <div class=" p-5 rounded-lg " id="profile" role="tabpanel" aria-labelledby="profile-tab">
            <div class="mb-5">
                <h2 class="text-white text-4xl font-extralight">Hallo <span class="text-white text-4xl font-extrabold">
                        {{ Auth::user()->name }} </span>
                </h2>
            </div>
            <div class="flex gap-5">
                <div class=" h-96 border rounded-lg flex items-center justify-center p-5 border-gray-500">
                    <div class="">
                        <img class="border object-cover w-52 h-52 rounded-full transition ease-out duration-1000 hover:scale-105"
                            src="https://scontent.fbdo7-1.fna.fbcdn.net/v/t1.6435-9/74308228_2455776411409305_3118347342969831424_n.jpg?_nc_cat=108&ccb=1-7&_nc_sid=174925&_nc_ohc=vVR1auJ93nEAX-ZfbcL&_nc_ht=scontent.fbdo7-1.fna&oh=00_AfCdbKuSlbnt3X6VWWgtD-sPEnpN7QQdlQw54j_aHp8W1w&oe=64B09FE2"
                            alt="">
                ...
                <div class="flex-auto border rounded-lg p-5 border-gray-500">
        ...
        <div class="hidden p-4 rounded-lg" id="settings" role="tabpanel" aria-labelledby="settings-tab">
            ...
            <div class="flex justify-center">
                <form runat="server" class="relative">
                    ...
                    <div class="absolute top-0 z-10  opacity-0 hover:opacity-100">
                        <label for="fotoProfilInput">
                            ...
                            <input accept="image/*" type='file' class="hidden" id="fotoProfilInput" />
                        </label>
                    </div>
                    <script>

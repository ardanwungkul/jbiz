<x-app-layout>
    <div class="mx-4 ">
         ...
         <a href="{{ route('pelanggan.create')}}"
                    class="w-full bg-gray-600 text-gray-300 p-3 rounded shadow-sm focus:outline-none hover:bg-indigo-700 text-sm" id="createNewProduct">Tambah Pelanggan</a>
                ...
                columns: [
                    ...
                    {data: 'nama_pelanggan', name: 'nama_pelanggan', 
                        render: function(data, type, full, meta) {
                            return '<a href="/pelanggan/' + full.id + ' ">' + full.nama_pelanggan +  '</a>';}},

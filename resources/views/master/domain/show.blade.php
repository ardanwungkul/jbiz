    ...
    <section class="bg-white dark:bg-gray-900 pt-3 mx-3 ">
        <div class="pb-3 mx-auto mt-5 rounded-xl max-w-2xl lg:pb-6 bg-gray-600 ">
            <div class="grid gap-2 sm:grid-cols-2 sm:gap-2">
                ...
                <div
                    class=" p-5 items-center justify-between grid grid-cols-2 col-span-2 font-medium text-left text-gray-500 rounded-t-xl bg-gray-800">

                    <div class="col-span-1">
                        <p class="text-white font-black font-sans tracking-widest text-xl">
                            {{ $domain->pelanggan->nama_pelanggan }}</p>
                        <div class="w-full text-gray-5  00 text-sm">
